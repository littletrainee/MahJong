...
import (
	...
	player "github.com/littletrainee/MahJong/ConsoleVersion/Dice/ThreePlayer/Player"
)

func (h *Handler) update(p1, p2, p3 *player.Player) {
	// Check p1 Is Tsumo
	p1.TsumoCheck()
	if !p1.Iswin.Get() {
...
func (h *Handler) Update() {
	for h.GameState.GameOn.Get() {
		...
		case 0: // Player1
			h.update(&h.Player1, &h.Player2, &h.Player3)
		case 1: // Player2
			h.update(&h.Player2, &h.Player3, &h.Player1)
		case 2: //Player3
			h.update(&h.Player3, &h.Player1, &h.Player2)
		}
	}
}
